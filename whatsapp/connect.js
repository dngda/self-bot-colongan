import { WAConnection as _WAConnection, MessageType } from '@adiwajshing/baileys'
...
let WAConnections = simple.WAConnection(_WAConnection)
const client = new WAConnections()
